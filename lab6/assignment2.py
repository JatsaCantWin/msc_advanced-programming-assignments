...
def client(address):
    ...
    put_block(sock, b'I like my toast done on one side')
    put_block(sock, b'And you can hear it in my accent when I talk')
    put_block(sock, b'I\'m an Englishman in New York')
    put_block(sock, b'')
    sock.close()
